...
import { type WebMapWebChart, type ActionModes, type CalculatedMinMaxBoundsPayload, type LegendItemVisibility, type NotifyOptions, type SelectionData, type ValidationStatus, type WebChartDataTypes } from 'arcgis-charts';
