...
export interface ItemListProps {
    ...
    /**
     * If is true, the infomation icon in the item card will link to item detail page (open in new tab).
     * If is false, click the infomation icon in the item card, will trigger item detail popper.
     */
