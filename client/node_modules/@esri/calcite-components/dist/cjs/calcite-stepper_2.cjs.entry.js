...
const Stepper = class {
    ...
    render() {
        return (index.h(index.Host, { "aria-label": this.messages.label, role: "region" }, index.h("div", { class: { container: true, [CSS$1.singleView]: !this.multipleViewMode }, ref: this.setContainerEl }, !this.multipleViewMode && this.layout === "horizontal" && (index.h("div", { class: { [CSS$1.stepBarContainer]: true } }, this.items.map((item, index$1) => (index.h(StepBar, { active: index$1 === this.currentActivePosition, complete: item.complete && index$1 !== this.currentActivePosition && !item.error, disabled: item.disabled && index$1 !== this.currentActivePosition, error: item.error && index$1 !== this.currentActivePosition, key: index$1 }))))), index.h("div", { class: { [CSS$1.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end")), index.h("slot", { onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const StepperItem = class {
    ...
    render() {
        return (index.h(index.Host, { "aria-current": this.selected ? "step" : "false", onClick: this.handleItemClick, onKeyDown: this.keyDownHandler }, index.h("div", { class: CSS.container }, this.complete && (index.h("span", { "aria-live": "polite", class: CSS.visuallyHidden }, this.messages.complete)), index.h("div", { class: CSS.stepperItemHeader, tabIndex: 
