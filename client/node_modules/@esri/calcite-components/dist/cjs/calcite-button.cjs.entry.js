...
const Button = class {
    ...
    render() {
        ...
        return (index.h(Tag, { "aria-disabled": childElType === "a" ? dom.toAriaBoolean(this.disabled || this.loading) : null, "aria-expanded": this.el.getAttribute("aria-expanded"), "aria-label": !this.loading ? label.getLabelText(this) : this.messages.loading, "aria-live": "polite", class: {
