...
const observers = require('./observers-fd7323b9.js');
const sortableComponent = require('./sortableComponent-2154f1fe.js');
const resources = require('./resources-586bde6f.js');
const loadable = require('./loadable-e9ed2d65.js');
const t9n = require('./t9n-92b64378.js');
const locale = require('./locale-78470e06.js');
const debounce = require('./debounce-5a61c8d6.js');
...
const ListItem = class {
    ...
    renderSelected() {
        ...
        return (index.h("td", { class: CSS$2.selectionContainer, key: "selection-container", onClick: this.handleItemClick }, index.h("calcite-icon", { icon: selected
    ...
    renderDragHandle() {
        ...
        return dragHandle ? (index.h("td", { "aria-label": label, class: CSS$2.dragContainer, key: "drag-handle-container", role: "gridcell",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.handleGridEl = el) }, index.h("calcite-handle", { disabled: dragDisabled, label: label, setPosition: setPosition, setSize: setSize }))) : null;
    }
    renderOpen() {
        ...
        return openable || parentListEl?.openable ? (index.h("td", { class: CSS$2.openContainer, key: "open-container", onClick: clickHandler }, index.h("calcite-icon", { icon: icon, key: icon, scale: "s" }))) : null;
    }
    renderActionsStart() {
    ...
    renderContentBottom() {
        ...
        return (index.h("div", { class: CSS$2.contentBottom, hidden: !hasContentBottom, style: { "--calcite-list-item-spacing-indent-multiplier": `${visualLevel}` } }, index.h("slot", { name: SLOTS$1.contentBottom, onSlotchange: this.handleContentBottomSlotChange })));
    }
