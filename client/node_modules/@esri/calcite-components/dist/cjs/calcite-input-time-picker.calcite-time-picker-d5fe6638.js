...
const form = require('./form-bd8d4323.js');
const guid = require('./guid-448f3e1e.js');
const interactive = require('./interactive-3760cd3a.js');
const key = require('./key-897cbb95.js');
const label = require('./label-6b071745.js');
const loadable = require('./loadable-e9ed2d65.js');
const locale$1 = require('./locale-78470e06.js');
const focusTrapComponent = require('./focusTrapComponent-0fe71be6.js');
const math = require('./math-c49a4c80.js');
const t9n = require('./t9n-92b64378.js');
const openCloseComponent = require('./openCloseComponent-10a646ab.js');
const component = require('./component-027255b4.js');
const Validation = require('./Validation-5cf3ef07.js');
...
const inputTimePickerCss = ":host([disabled]){cursor:default;-webkit-user-select:none;user-select:none;opacity:var(--calcite-opacity-disabled)}:host([disabled]) *,:host([disabled]) ::slotted(*){pointer-events:none}:host{display:inline-block;-webkit-user-select:none;user-select:none}:host([disabled]) ::slotted([calcite-hydrated][disabled]),:host([disabled]) [calcite-hydrated][disabled]{opacity:1}::slotted(input[slot=hidden-form-input]){margin:0 !important;opacity:0 !important;outline:none !important;padding:0 !important;position:absolute !important;inset:0 !important;transform:none !important;-webkit-appearance:none !important;z-index:-1 !important}:host([scale=s]){--calcite-toggle-spacing:0.5rem;--calcite-internal-input-text-input-padding-inline-end:calc(var(--calcite-toggle-spacing) + 1rem)}:host([scale=m]){--calcite-toggle-spacing:0.75rem;--calcite-internal-input-text-input-padding-inline-end:calc(var(--calcite-toggle-spacing) + 1.5rem)}:host([scale=l]){--calcite-toggle-spacing:1rem;--calcite-internal-input-text-input-padding-inline-end:calc(var(--calcite-toggle-spacing) + 2rem)}.input-wrapper{position:relative}.toggle-icon{position:absolute;display:flex;cursor:pointer;align-items:center;inset-inline-end:0;inset-block:0;padding-inline:var(--calcite-toggle-spacing)}.validation-container{padding-block-start:0.5rem;display:flex;flex-direction:column;align-items:flex-start;align-self:stretch}:host([hidden]){display:none}[hidden]{display:none}";

// some bundlers (e.g., Webpack) need dynamic import paths to be static
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => Promise.resolve().then(function () { return require('./ar-73b4993c.js'); })],
    ["bg", () => Promise.resolve().then(function () { return require('./bg-450e1a34.js'); })],
    ["bs", () => Promise.resolve().then(function () { return require('./bs-99e128a2.js'); })],
    ["ca", () => Promise.resolve().then(function () { return require('./ca-0c02ba36.js'); })],
    ["cs", () => Promise.resolve().then(function () { return require('./cs-332c265b.js'); })],
    ["da", () => Promise.resolve().then(function () { return require('./da-1b8c4b09.js'); })],
    ["de", () => Promise.resolve().then(function () { return require('./de-7723af91.js'); })],
    ["de-at", () => Promise.resolve().then(function () { return require('./de-at-e295c005.js'); })],
    ["de-ch", () => Promise.resolve().then(function () { return require('./de-ch-ddc6aaa7.js'); })],
    ["el", () => Promise.resolve().then(function () { return require('./el-fb30e396.js'); })],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => Promise.resolve().then(function () { return require('./en-au-d4fc24c1.js'); })],
    ["en-ca", () => Promise.resolve().then(function () { return require('./en-ca-a6d58b4e.js'); })],
    ["en-gb", () => Promise.resolve().then(function () { return require('./en-gb-be1be611.js'); })],
    ["es", () => Promise.resolve().then(function () { return require('./es-213c2bb8.js'); })],
    ["es-mx", () => Promise.resolve().then(function () { return require('./es-mx-31664a67.js'); })],
    ["et", () => Promise.resolve().then(function () { return require('./et-c8ea1e06.js'); })],
    ["fi", () => Promise.resolve().then(function () { return require('./fi-623f5659.js'); })],
    ["fr", () => Promise.resolve().then(function () { return require('./fr-60d2c040.js'); })],
    ["fr-ch", () => Promise.resolve().then(function () { return require('./fr-ch-7ef66213.js'); })],
    ["he", () => Promise.resolve().then(function () { return require('./he-bdb6f313.js'); })],
    ["hi", () => Promise.resolve().then(function () { return require('./hi-045d1d4e.js'); })],
    ["hr", () => Promise.resolve().then(function () { return require('./hr-e51c4c14.js'); })],
    ["hu", () => Promise.resolve().then(function () { return require('./hu-53408f27.js'); })],
    ["id", () => Promise.resolve().then(function () { return require('./id-ab756bdd.js'); })],
    ["it", () => Promise.resolve().then(function () { return require('./it-decfebf9.js'); })],
    ["it-ch", () => Promise.resolve().then(function () { return require('./it-ch-d5d78467.js'); })],
    ["ja", () => Promise.resolve().then(function () { return require('./ja-d23af67d.js'); })],
    ["ko", () => Promise.resolve().then(function () { return require('./ko-82e7d7b0.js'); })],
    ["lt", () => Promise.resolve().then(function () { return require('./lt-4b4cf946.js'); })],
    ["lv", () => Promise.resolve().then(function () { return require('./lv-4e52794e.js'); })],
    ["mk", () => Promise.resolve().then(function () { return require('./mk-5a2f7cae.js'); })],
    ["nl", () => Promise.resolve().then(function () { return require('./nl-d5cad780.js'); })],
    ["nb", () => Promise.resolve().then(function () { return require('./nb-4e63496e.js'); })],
    ["pl", () => Promise.resolve().then(function () { return require('./pl-7d69e7eb.js'); })],
    ["pt", () => Promise.resolve().then(function () { return require('./pt-14653015.js'); })],
    ["pt-br", () => Promise.resolve().then(function () { return require('./pt-br-3b6c8890.js'); })],
    ["ro", () => Promise.resolve().then(function () { return require('./ro-bd5a802a.js'); })],
    ["ru", () => Promise.resolve().then(function () { return require('./ru-df1a9461.js'); })],
    ["sk", () => Promise.resolve().then(function () { return require('./sk-1bcda4fb.js'); })],
    ["sl", () => Promise.resolve().then(function () { return require('./sl-17cfff2e.js'); })],
    ["sr", () => Promise.resolve().then(function () { return require('./sr-c9b6eb40.js'); })],
    ["sv", () => Promise.resolve().then(function () { return require('./sv-b27cf03b.js'); })],
    ["th", () => Promise.resolve().then(function () { return require('./th-71a811bc.js'); })],
    ["tr", () => Promise.resolve().then(function () { return require('./tr-793c1e07.js'); })],
    ["uk", () => Promise.resolve().then(function () { return require('./uk-ce49e27e.js'); })],
    ["vi", () => Promise.resolve().then(function () { return require('./vi-8f329834.js'); })],
    ["zh-cn", () => Promise.resolve().then(function () { return require('./zh-cn-da7c3296.js'); })],
    ["zh-hk", () => Promise.resolve().then(function () { return require('./zh-hk-91f2ca46.js'); })],
    ["zh-tw", () => Promise.resolve().then(function () { return require('./zh-tw-edb7fb24.js'); })],
]);
...
const InputTimePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onBlur: this.hostBlurHandler, onKeyDown: this.keyDownHandler }, index.h("div", { class: "input-wrapper", onClick: this.onInputWrapperClick }, index.h("calcite-input-text", { "aria-autocomplete": "none", "aria-haspopup": "dialog", disabled: disabled, icon: "clock", id: this.referenceElementId, label: label.getLabelText(this), lang: this.effectiveLocale, onCalciteInputTextInput: this.calciteInternalInputInputHandler, onCalciteInternalInputTextFocus: this.calciteInternalInputFocusHandler, readOnly: readOnly, role: "combobox", scale: this.scale, status: this.status,
...
//# sourceMappingURL=calcite-input-time-picker.calcite-time-picker-d5fe6638.js.map