...
const utils = require('./utils-ca2668d2.js');
const dom = require('./dom-6bd6bcac.js');
const floatingUi = require('./floating-ui-0e34e76e.js');
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, this.localeData && (index.h("div", { class: CSS.inputContainer }, index.h("div", { class: CSS.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setEndInput }), !this.readOnly && this.renderToggleIcon(this.open && this.focusedInput === "end"))))), index.h(form.HiddenFormInputSlot, { component: this }), this.validationMessage ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
