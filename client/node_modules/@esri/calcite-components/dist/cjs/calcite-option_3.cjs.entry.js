...
const Select = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: CSS.wrapper }, index.h("select", { "aria-label": label.getLabelText(this), class: CSS.select, disabled: this.disabled, onChange: this.handleInternalSelectChange,
