...
const CalciteNavigationLogo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("a", { class: CSS$1.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && index.h("img", { alt: this.label || "", class: CSS$1.image, src: thumbnail }), this.icon && this.renderIcon(), (heading || description) && (index.h("div", { class: CSS$1.container }, heading && (index.h("span", { "aria-label": this.heading, class: {
                [CSS$1.heading]: true,
