...
export class List {
    ...
    renderItemAriaLive() {
        ...
        return !parentListEl ? (h("div", { "aria-live": "polite", class: CSS.assistiveText }, filterEnabled && filterText && filteredData?.length ? (h("div", { key: "aria-filter-enabled" }, messages.filterEnabled)) : null, h("div", { key: "aria-item-count" }, messages.total.replace("{count}", numberStringFormatter.localize(enabledListItems.length.toString()))), enabledListItems.length ? (h("ol", { key: "aria-item-list" }, enabledListItems.map((item) => (h("li", null, item.label))))) : null)) : null;
    }
    connectObserver() {
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "Emits when the component's dragging has ended."
                },
                "complexType": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Emits when the component's dragging has started."
                },
                "complexType": {
                    "original": "ListDragDetail",
                    "resolved": "ListDragDetail",
