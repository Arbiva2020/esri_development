    ...
    static get properties() {
        return {
            ...
            "position": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Specifies the position of `calcite-tab-nav` and `calcite-tab-title` components in relation to the `calcite-tabs`, defaults to `top`."
                },
                "attribute": "position",
                "reflect": true,
                "defaultValue": "\"top\""
            ...
            "scale": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Specifies the size of the component, defaults to `m`."
                },
                "attribute": "scale",
                "reflect": true,
                "defaultValue": "\"m\""
