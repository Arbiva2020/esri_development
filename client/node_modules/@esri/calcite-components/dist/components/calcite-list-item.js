...
import { a as getDepth, C as CSS, I as ICONS, S as SLOTS, g as getListItemChildren, b as getListItemChildLists, u as updateListItemChildren } from './utils3.js';
...
const ListItem = /*@__PURE__*/ proxyCustomElement(class ListItem extends HTMLElement {
    ...
    renderSelected() {
        ...
        return (h("td", { class: CSS.selectionContainer, key: "selection-container", onClick: this.handleItemClick }, h("calcite-icon", { icon: selected
    ...
    renderDragHandle() {
        ...
        return dragHandle ? (h("td", { "aria-label": label, class: CSS.dragContainer, key: "drag-handle-container", role: "gridcell",
    ...
    renderOpen() {
        ...
        return openable || parentListEl?.openable ? (h("td", { class: CSS.openContainer, key: "open-container", onClick: clickHandler }, h("calcite-icon", { icon: icon, key: icon, scale: "s" }))) : null;
    }
    renderActionsStart() {
