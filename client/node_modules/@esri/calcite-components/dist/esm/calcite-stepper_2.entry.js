 ...
 * v2.1.0
 */
import { h, r as registerInstance, c as createEvent, H as Host, e as readTask, g as getElement } from './index-433aebec.js';
import { s as slotChangeGetAssignedElements, l as focusElementInGroup } from './dom-f74f388a.js';
import { c as createObserver } from './observers-7bffaed0.js';
import { g as guid } from './guid-e5232da1.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter } from './locale-8f40ca35.js';
...
const Stepper = class {
    ...
    render() {
        return (h(Host, { "aria-label": this.messages.label, role: "region" }, h("div", { class: { container: true, [CSS$1.singleView]: !this.multipleViewMode }, ref: this.setContainerEl }, !this.multipleViewMode && this.layout === "horizontal" && (h("div", { class: { [CSS$1.stepBarContainer]: true } }, this.items.map((item, index) => (h(StepBar, { active: index === this.currentActivePosition, complete: item.complete && index !== this.currentActivePosition && !item.error, disabled: item.disabled && index !== this.currentActivePosition, error: item.error && index !== this.currentActivePosition, key: index }))))), h("div", { class: { [CSS$1.actionContainer]: true } }, this.renderAction("start"), this.renderAction("end")), h("slot", { onSlotchange: this.handleDefaultSlotChange }))));
    }
    //--------------------------------------------------------------------------
    //
    //  Event Listeners
...
const StepperItem = class {
    ...
    render() {
        return (h(Host, { "aria-current": this.selected ? "step" : "false", onClick: this.handleItemClick, onKeyDown: this.keyDownHandler }, h("div", { class: CSS.container }, this.complete && (h("span", { "aria-live": "polite", class: CSS.visuallyHidden }, this.messages.complete)), h("div", { class: CSS.stepperItemHeader, tabIndex: 
