 ...
 * v2.1.0
 */
import { r as registerInstance, c as createEvent, h, g as getElement } from './index-433aebec.js';
...
const Handle = class {
    ...
    render() {
        ...
        h("span", { "aria-disabled": this.disabled ? toAriaBoolean(this.disabled) : null, "aria-label": this.disabled ? null : this.getAriaText("label"), "aria-pressed": this.disabled ? null : toAriaBoolean(this.activated), class: { [CSS.handle]: true, [CSS.handleActivated]: !this.disabled && this.activated }, onBlur: this.handleBlur, onKeyDown: this.handleKeyDown, role: "button", tabIndex: this.disabled ? null : 0, title: this.messages?.dragHandle,
