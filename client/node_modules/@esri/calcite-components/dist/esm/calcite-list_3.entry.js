 ...
 * v2.1.0
 */
import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-433aebec.js';
import { b as slotChangeHasAssignedElement, t as toAriaBoolean, D as getFirstTabbable, g as getElementDir } from './dom-f74f388a.js';
...
import { d as dragActive, a as disconnectSortableComponent, c as connectSortableComponent } from './sortableComponent-bc8bff42.js';
import { S as SLOTS$2 } from './resources-9ef7ad5d.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-31b2a807.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages, u as updateMessages } from './t9n-0c281238.js';
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-8f40ca35.js';
import { d as debounce } from './debounce-c64f6f49.js';
import './guid-e5232da1.js';
...
const List = class {
    ...
    renderItemAriaLive() {
        ...
        return !parentListEl ? (h("div", { "aria-live": "polite", class: CSS$1.assistiveText }, filterEnabled && filterText && filteredData?.length ? (h("div", { key: "aria-filter-enabled" }, messages.filterEnabled)) : null, h("div", { key: "aria-item-count" }, messages.total.replace("{count}", numberStringFormatter.localize(enabledListItems.length.toString()))), enabledListItems.length ? (h("ol", { key: "aria-item-list" }, enabledListItems.map((item) => (h("li", null, item.label))))) : null)) : null;
    }
    connectObserver() {
...
const ListItem = class {
    ...
    renderSelected() {
        ...
        return (h("td", { class: CSS$2.selectionContainer, key: "selection-container", onClick: this.handleItemClick }, h("calcite-icon", { icon: selected
    ...
    renderDragHandle() {
        ...
        return dragHandle ? (h("td", { "aria-label": label, class: CSS$2.dragContainer, key: "drag-handle-container", role: "gridcell",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.handleGridEl = el) }, h("calcite-handle", { disabled: dragDisabled, label: label, setPosition: setPosition, setSize: setSize }))) : null;
    }
    renderOpen() {
    ...
    renderContentContainer() {
        ...
        return (h("td", { "aria-label": label, class: {
            ...
            }, key: "content-container", onClick: this.handleItemClick, role: "gridcell",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
