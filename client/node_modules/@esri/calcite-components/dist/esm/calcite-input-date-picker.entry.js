...
import { d as datePartsFromISO, a as datePartsFromLocalizedString, b as dateFromLocalizedString, i as inRange, c as dateToISO, g as getValueAsDateRange, e as dateFromISO, f as getLocaleData, h as dateFromRange } from './utils-53a6c054.js';
import { t as toAriaBoolean } from './dom-f74f388a.js';
import { f as filterComputedPlacements, c as connectFloatingUI, d as defaultMenuPlacement, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-e667a8e7.js';
...
import { c as connectLabel, d as disconnectLabel } from './label-191228ce.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-31b2a807.js';
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized, b as getSupportedNumberingSystem } from './locale-8f40ca35.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-f1a58cd7.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages } from './t9n-0c281238.js';
import { c as connectFocusTrap, d as deactivateFocusTrap, a as activateFocusTrap } from './focusTrapComponent-f339292e.js';
...
import './debounce-c64f6f49.js';
import './browser-f0a06003.js';
import './observers-7bffaed0.js';
...
const InputDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, this.localeData && (h("div", { class: CSS.inputContainer }, h("div", { class: CSS.inputWrapper, "data-position": "start", onClick: this.onInputWrapperClick, onPointerDown: this.onInputWrapperPointerDown,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setEndInput }), !this.readOnly && this.renderToggleIcon(this.open && this.focusedInput === "end"))))), h(HiddenFormInputSlot, { component: this }), this.validationMessage ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
