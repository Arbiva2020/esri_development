 ...
 * v2.1.0
 */
import { r as registerInstance, c as createEvent, h, g as getElement, F as Fragment, H as Host } from './index-433aebec.js';
import { c as createObserver } from './observers-7bffaed0.js';
import { d as focusElement } from './dom-f74f388a.js';
import { c as connectForm, d as disconnectForm, a as afterConnectDefaultValueSet, H as HiddenFormInputSlot } from './form-5cf1adb5.js';
...
const Select = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: CSS.wrapper }, h("select", { "aria-label": getLabelText(this), class: CSS.select, disabled: this.disabled, onChange: this.handleInternalSelectChange,
