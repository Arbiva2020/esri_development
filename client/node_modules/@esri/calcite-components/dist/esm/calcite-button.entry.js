 ...
 * v2.1.0
 */
import { r as registerInstance, f as forceUpdate, h, g as getElement } from './index-433aebec.js';
import { s as submitForm, r as resetForm, f as findAssociatedForm } from './form-5cf1adb5.js';
...
const Button = class {
    ...
    render() {
        ...
        return (h(Tag, { "aria-disabled": childElType === "a" ? toAriaBoolean(this.disabled || this.loading) : null, "aria-expanded": this.el.getAttribute("aria-expanded"), "aria-label": !this.loading ? getLabelText(this) : this.messages.loading, "aria-live": "polite", class: {
