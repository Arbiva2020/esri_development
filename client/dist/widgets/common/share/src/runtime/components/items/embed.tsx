            ...
            <div role='group' aria-label={embedOptionsNls}>
              ...
              <div className='d-flex align-items-center embed-options-wrapper justify-content-between w-100'>
                ...
                <div className='d-flex align-items-center'>
                  <TextInput value={this.state.w} aria-label={widthNls} className='flex-fill embed-option embed-option-w' onChange={this.onWChange} />
                  X
                  <TextInput value={this.state.h} aria-label={heightNls} className='flex-fill embed-option embed-option-h' onChange={this.onHChange} />
                </div>
              </div>
            </div>
          </div>
