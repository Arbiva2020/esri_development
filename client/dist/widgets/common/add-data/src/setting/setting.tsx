...
import { getDefaultItemCategoriesInfo, useDefaultItemCategoryNames } from '../utils'
...
const Setting = (props: AllWidgetSettingProps<IMConfig>) => {
  ...
  const createListItemElement = (itemCategoryInfo: ItemCategoryInfo, index: number) => {
    return <SearchConfigItem
      ...
      defaultLabel={defaultItemCategoryNames.get(itemCategoryInfo.type)}
    ...
    onSettingChange({
      ...
      config: {
        ...
        itemCategoriesInfo: [...config.itemCategoriesInfo, {
          ...
          enabled: true,
          curatedFilter: '',
          id: `${ItemCategory.Curated}_${curatedIdRef.current}`
        }]
      }
    })
    curatedIdRef.current = curatedIdRef.current + 1
  }
