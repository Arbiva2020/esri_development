...
export const FixedLayoutStyleSetting = (props: FixedLayoutSettingProps) => {
  ...
  return (
    <Root className='fixed-layout-style-setting'>
      ...
      <SettingRow className='mt-3' flow='no-wrap' label={translate('offsetX')}>
        <NumericInput aria-label={translate('offsetX')} className='offset-numeric-input' value={originValue.offsetX} onAcceptValue={(offsetX) => { handleChange('offsetX', offsetX) }} />
      </SettingRow>
      <SettingRow className='mt-3' flow='no-wrap' label={translate('offsetY')}>
        <NumericInput aria-label={translate('offsetY')} className='offset-numeric-input' value={originValue.offsetY} onAcceptValue={(offsetY) => { handleChange('offsetY', offsetY) }} />
      </SettingRow>
      <Divider></Divider>
