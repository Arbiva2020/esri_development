/**@jsx jsx */
import { React, jsx, ReactRedux, type IMState, appActions, getAppStore, type Size, Immutable, WidgetState, css, type LayoutItemConstructorProps, BrowserSizeMode, hooks } from 'jimu-core'
...
export const Builder = (props: BuilderProps) => {
  ...
  const layout = React.useMemo(() => getWidgetChildLayoutJson(id, BASE_LAYOUT_NAME), [id])
  ...
  const onItemSelect = (item: LayoutItemConstructorProps) => {
    ...
    insertWidgetToLayout(layout, item, {} as any, {} as any, insertIndex)
  }

  return <div className='controller-builder w-100 h-100' ref={rootRef} onClick={handleRootClick}>
    {(firstOpeningWidget && floatingMode) && <DummyLayout
      reference={reference}
      version={version}
