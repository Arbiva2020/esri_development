...
const TemplateSetting = (props: Props) => {
  ...
  `
  const { templateList, jimuMapView, selectedTemplate, id, confirmPrint, views, handleSelectedTemplateChange, setSelectedTemplateByIndex } = props
  ...
  return (
    <div className='w-100 h-100' css={STYLE}>
      {views === Views.PrintTemplate && <div className='w-100 h-100 d-flex flex-column'>
