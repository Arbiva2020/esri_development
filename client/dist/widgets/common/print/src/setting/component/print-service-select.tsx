/** @jsx jsx */
import { React, jsx, css, polished, Immutable, type IMUseUtility, type UseUtility, type ImmutableArray, SupportedUtilityType, hooks } from 'jimu-core'
...
const PrintServiceSelect = (props: Props) => {
  ...
  const { config, id, showLoading, onSettingChange, toggleLoading, toggleRemindPopper } = props
