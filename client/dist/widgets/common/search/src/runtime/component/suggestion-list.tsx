...
import { Icon, DropdownItem, Button, defaultMessages as jimuiDefaultMessage } from 'jimu-ui'
...
const SuggestionList = (props: SearchSettingProps) => {
  ...
  const { isRecentSearches, className, reference, searchSuggestion, isOpen, searchText, canUseOutoutDsLength, serviceList, isShowCurrentLocation, id, searchInputRef, toggel, onRecordItemClick, clearSearches, setSuggestionFirstItem } = props
  ...
  return (
    <div>
      ...
      >
        ...
        {isRecentSearches && <Button role='button' className='clear-recent-search-con jimu-outline-inside' title={nls('clearRecentSearches')} onClick={clearSearches}>
