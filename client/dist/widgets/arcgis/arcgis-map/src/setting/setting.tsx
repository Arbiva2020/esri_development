...
import { Alert, Switch, ImageWithParam, Radio, defaultMessages as mapDefaultMessages, Select } from 'jimu-ui'
        ...
        <SettingSection title={this.props.intl.formatMessage({ id: 'options', defaultMessage: defaultMessages.options })}>
          <SettingRow>
            <div className='w-100 webmap-tools'>
              ...
              <div className='webmap-tools-item' style={{ color: `${this.props.theme.colors.palette.dark[400]}` }}>
                <label id='highlightFill'><FormattedMessage id='featureHighlightFill' defaultMessage={defaultMessages.featureHighlightFill} /></label>
                <div>
                  <ColorPicker
              ...
              <div className='webmap-tools-item' style={{ marginTop: 17, marginBottom: 16 }}>
                <label id='enableScrollZoomTool'><FormattedMessage id='enableScrollZoom' defaultMessage={defaultMessages.enableScrollZoom} /></label>
                <Switch
              ...
              <div className='webmap-tools-item' style={{ marginBottom: 16 }}>
                <span id='enablePopupTool' className='text-break' style={{ width: '80%' }}><FormattedMessage id='enablePopUp' defaultMessage={defaultMessages.enablePopUp} /></span>
                <Switch
