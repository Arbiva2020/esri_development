import {
  ...
  getAppStore, appActions, MutableStoreManager, type ExtentChangeMessage, type UseDataSource, type ImmutableObject, type JimuMapViewInfo
} from 'jimu-core'
...
import { MapViewManager, type JimuMapView, type JimuMapViewGroup, JimuMapViewComponent, type DefaultMapInfo, ActionType, DataChangeType } from 'jimu-arcgis'
import MapFixedLayout from '../layout/map-fixed-layout'
import Layout, { type ActiveToolInfo } from '../layout/layout'
