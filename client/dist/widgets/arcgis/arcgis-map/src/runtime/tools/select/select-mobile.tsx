...
export class SelectMobileTool extends React.PureComponent<Props, States> {
  ...
  getSelectIconTitle () {
    ...
    if (this.state.currentSelectType === 'Point') {
      selectTitle = this.props.intl.formatMessage({ id: 'SelectionByPoint', defaultMessage: defaultMessages.SelectionByPoint })
    } else if (this.state.currentSelectType === 'Rectangle') {
      selectTitle = this.props.intl.formatMessage({ id: 'SelectionByRectangle', defaultMessage: defaultMessages.SelectionByRectangle })
    } else if (this.state.currentSelectType === 'Lasso') {
      selectTitle = this.props.intl.formatMessage({ id: 'SelectionByLasso', defaultMessage: defaultMessages.SelectionByLasso })
    } else if (this.state.currentSelectType === 'Circle') {
      selectTitle = this.props.intl.formatMessage({ id: 'SelectionByCircle', defaultMessage: defaultMessages.SelectionByCircle })
    } else if (this.state.currentSelectType === 'Line') {
      selectTitle = this.props.intl.formatMessage({ id: 'SelectionByLine', defaultMessage: defaultMessages.SelectionByLine })
    } else {
      selectTitle = this.props.intl.formatMessage({ id: 'SelectLabel', defaultMessage: defaultMessages.SelectLabel })
    }
