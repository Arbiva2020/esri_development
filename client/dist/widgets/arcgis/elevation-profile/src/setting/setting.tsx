/** @jsx jsx */
import { React, jsx, DataSourceManager, urlUtils, defaultMessages as jimuCoreDefaultMessages, getAppStore, Immutable, type FieldSchema, JimuFieldType, type DataSourceSchema, type DataSourceJson, DataSourceTypes, type ImmutableArray } from 'jimu-core'
import { Icon, Tooltip, Button, Alert, Label, CollapsablePanel, defaultMessages as jimuUIDefaultMessages, Switch, Radio, Loading, LoadingType } from 'jimu-ui'
...
import { type IMConfig, type Statistics } from '../config'
...
export default class Setting extends BaseWidgetSetting<AllWidgetSettingProps<IMConfig>, State> {
  ...
  getConfigForSelectedDs = (activeDataSource: string, useMapWidgetIds: ImmutableArray<string>) => {
          ...
          if (updatedMapViewGroups.jimuMapViews[id].dataSourceId) {
            ...
            setTimeout(() => {
              this.setState({
                ...
                this.getConfigForSelectedDs(updatedMapViewGroups.jimuMapViews[id].dataSourceId, useMapWidgetIds)
          ...
          if (updatedMapViewGroups && updatedMapViewGroups.jimuMapViews) {
            for (const id in updatedMapViewGroups.jimuMapViews) {
              ...
              this.setState({
                ...
                this.getConfigForSelectedDs(this.state.activeDataSource, useMapWidgetIds)
              })
            }
          }
        }
  ...
  */
  showDsPanel = (item: any, index?: number) => {
    ...
    this.getConfigForSelectedDs(item.value, this.props.useMapWidgetIds)
  }
