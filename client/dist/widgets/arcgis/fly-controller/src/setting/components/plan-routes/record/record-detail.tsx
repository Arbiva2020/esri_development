...
import { type RecordConfig, type RotateRecordConfig, type PathRecordConfig, type PathType } from '../../../../common/fly-facade/route/record/record'
import type Record from '../../../../common/fly-facade/route/record/record'
