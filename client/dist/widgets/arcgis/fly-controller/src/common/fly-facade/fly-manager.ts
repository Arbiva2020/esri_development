...
import {
  ...
  type RouteItemConfig, type ItemsType, type RotateItemConfig, type PathItemConfig
} from '../../config'
...
import Routes, { type RouteConfig } from './route/routes'
import Record, { type RecordConfig, StoredGraphicsType } from './route/record/record'
