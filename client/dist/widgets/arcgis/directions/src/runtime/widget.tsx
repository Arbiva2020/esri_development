/** @jsx jsx */
import { React, jsx, css, type AllWidgetProps, DataSourceManager, DataSourceStatus, type FeatureLayerDataSource, dataSourceUtils, type UseUtility, UtilityManager, getAppStore, hooks } from 'jimu-core'
...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  }, [id, jimuMapView?.view, searchConfig, routeConfig?.useUtility, defaultSearchHint, isReadyToRenderDirections, isDarkTheme])
