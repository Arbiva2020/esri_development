...
export default class BAMapActions {
  ...
  /** constructor
     ...
     * }
     */
  constructor (widgetId: string, mapId: string, showSearch: boolean, env: string, reportChangeCallback: any, context, searchPlaceholderLocalized: string, geoenrichmentServiceUrl: string) {
