...
import { type IMLayoutItemJson, type IMLayoutJson } from './app-config';
...
export type LayoutTransformFunc = (layout: IMLayoutJson, fromSizeMode: BrowserSizeMode, toSizeMode: BrowserSizeMode) => IMLayoutJson;
