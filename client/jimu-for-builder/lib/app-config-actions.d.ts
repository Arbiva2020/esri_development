import { type IMAppConfig, type IMAttributesJson, type IMCustomThemeJson, type IMDataSourceJson, type IMDialogJson, type IMFooterJson, type IMHeaderJson, type IMLayoutJson, type IMMessageJson, type IMPageJson, type IMViewJson, type IMSectionJson, type IMWidgetJson, type LayoutInfo, LayoutType, type IMSizeModeLayoutJson, type IMLayoutItemJson, type BrowserSizeMode, type Size, type DataSourceJson, type WidgetJson, type BoundingBox, type IMProxyJson, type IMScreenGroupJson, type IMScreenJson, type UseDataSource, type IMUseDataSource, type IMUtilitiesJson, type UtilityJson, type ControllerPanelJson } from 'jimu-core';
...
export declare class AppConfigAction {
   ...
   */
    ...
    clearParentOfContent(layoutInfo: LayoutInfo, recursive: boolean, browserSizeMode?: BrowserSizeMode): void;
    setParentOfContent(layoutInfo: LayoutInfo, recursive: boolean, browserSizeMode?: BrowserSizeMode): void;
    /**
     * Clear the layout structure from scratch
     * @param layoutId
     * @param sizeMode
     * @param recursive
     */
    clearLayoutStructure(layoutId: string, sizeMode: BrowserSizeMode, recursive: boolean): void;
    /**
     * Build the layout structure from scratch. Replace the parent info for the sizeMode if exists.
     * @param layoutId
     * @param sizeMode
     * @param recursive
     */
    buildLayoutStructure(layoutId: string, sizeMode: BrowserSizeMode, recursive: boolean): void;
    /**
